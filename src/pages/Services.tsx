    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground mb-12">Comprehensive Oracle and IT consulting solutions for your business.</p>
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              <div key={s.title} className="bg-secondary rounded-lg p-8 text-left">
