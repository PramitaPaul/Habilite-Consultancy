...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero */}
      <section className="relative h-[45vh] sm:h-[55vh] md:h-[60vh] flex items-center justify-center">
        <img src={aboutHero} alt="About hero" className="absolute inset-0 w-full h-full object-cover" />
        <div className="absolute inset-0 bg-foreground/40" />
        <div className="relative z-10 bg-card/90 backdrop-blur-sm rounded-xl p-6 sm:p-10 max-w-2xl text-center mx-4 sm:mx-6">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground mb-3 sm:mb-4">About Habilite Consultancy</h1>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            <a href="/services" className="px-5 sm:px-6 py-3 bg-primary text-primary-foreground font-medium rounded hover:bg-primary/90 transition-colors text-sm sm:text-base">
              Learn More
            </a>
            <a href="/contact" className="px-5 sm:px-6 py-3 text-primary font-medium hover:underline text-sm sm:text-base">
              Contact Us
            </a>
          </div>
        </div>
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-4 sm:mb-6">Who we are</h2>
          ...
          <img src={aboutWriting} alt="Who we are" className="rounded-lg shadow-lg w-full h-56 sm:h-72 md:h-80 object-cover" />
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <img src={aboutTeam} alt="Our mission" className="rounded-lg shadow-lg w-full h-56 sm:h-72 md:h-80 object-cover order-1 md:order-2" />
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-4 sm:mb-6">Industries we serve</h2>
            <p className="text-muted-foreground text-sm sm:text-base mb-4">
            ...
            <ul className="list-disc list-inside text-muted-foreground text-sm sm:text-base mb-4 space-y-1">
          ...
          <img src={aboutDiscussion} alt="Industries" className="rounded-lg shadow-lg w-full h-56 sm:h-72 md:h-80 object-cover" />
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <img src={aboutVision} alt="Our vision" className="rounded-lg shadow-lg w-full h-56 sm:h-72 md:h-80 object-cover" />
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 bg-secondary">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-bold text-center text-foreground mb-8 sm:mb-12">Our Journey</h2>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
            {journey.slice(0, 3).map((j) => (
              <div key={j.year} className="bg-card rounded-lg p-4 sm:p-8 text-center shadow-sm">
                <p className="text-lg sm:text-xl font-bold text-primary mb-2">{j.year}</p>
                <p className="text-muted-foreground text-xs sm:text-base">{j.text}</p>
              </div>
            ))}
          </div>
          <div className="flex justify-center mt-4 sm:mt-6">
            <div className="bg-card rounded-lg p-4 sm:p-8 text-center shadow-sm max-w-xs w-full">
              <p className="text-lg sm:text-xl font-bold text-primary mb-2">{journey[3].year}</p>
              <p className="text-muted-foreground text-xs sm:text-base">{journey[3].text}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-3 sm:mb-4">Meet our experts</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8">
            {team.map((member) => (
              <div key={member.name} className="flex flex-col items-center bg-card rounded-lg p-4 sm:p-6 shadow-sm border">
                <div className="w-14 h-14 sm:w-20 sm:h-20 rounded-full border-2 border-primary flex items-center justify-center mb-2 sm:mb-3">
                  <span className="text-primary font-bold text-sm sm:text-lg">{member.initials}</span>
                </div>
                <p className="font-bold text-foreground text-sm sm:text-base">{member.name}</p>
